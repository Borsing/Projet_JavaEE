    ...
    <div class="mdl-grid">
        <div class="mdl-cell mdl-cell--6-col  mdl-cell--3-offset">
            ...
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="text" id="first_name" name="5_first_name" required="true" value="${session.first_name}">
                <label class="mdl-textfield__label" for="first_name">Prénom</label>
            </div>
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="text" id="last_name" name="4_last_name" required="true" value="${session.last_name}">
                <label class="mdl-textfield__label" for="last_name">Nom</label>
            </div><br>

            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="text" id="company" name="6_company" value="${session.company}">
                <label class="mdl-textfield__label" for="company">Société</label>
            </div>
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="email" id="new_email" name="2_new_email" required="true" value="${session.mail}">
            ...
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="password" id="password" name="3_password" required="true" value="${session.password}">
                <label class="mdl-textfield__label" for="password">Mot de passe</label>
            </div><br>

            <input type="hidden" id="last_email" name="1_last_email" value="${session.mail}"/>
...
<div class="mdl-grid">
    <div class="mdl-cell mdl-cell--6-col  mdl-cell--3-offset">
        ...
        <form action="unregister" method="post">
            <input type="hidden" name="1_email" value="${session.mail}"/>

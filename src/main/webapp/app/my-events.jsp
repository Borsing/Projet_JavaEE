                ...
                <div class="mdl-textfield__expandable-holder">
                    <c:choose>
                        <c:when test="${session==null}">
                            <input class="mdl-textfield__input" type="email" id="email" name="1_email" required>
                        </c:when>
                        <c:otherwise>
                            <input class="mdl-textfield__input" type="email" id="email" name="1_email" value="${session.mail}" required>
                        </c:otherwise>
                    </c:choose>

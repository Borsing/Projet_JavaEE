...
public class DatabaseManager {
    ...
    public void populate() throws PersistenceException, ClassNotFoundException, ParseException {
        ...
        try {
            ...
            EventEntity event1 = new EventEntity("Event de Adrien", "C'est l'événement d'Adrien", (Date)ArgumentsParser.convertTo(Date.class, "14-05-2016"),(Date)ArgumentsParser.convertTo(Date.class, "14-05-2016"), "Adresse d'Adrien", organizer1, null);
            EventEntity event2 = new EventEntity("Event de Benjamin", "C'est l'événement de Benjamin", (Date)ArgumentsParser.convertTo(Date.class, "14-05-2016"),(Date)ArgumentsParser.convertTo(Date.class, "15-05-2016"), "Adresse de Benjamin", organizer2, null);
            EventEntity event3 = new EventEntity("Event de Denis", "C'est l'événement de Denis", (Date)ArgumentsParser.convertTo(Date.class, "16-05-2016"),(Date)ArgumentsParser.convertTo(Date.class, "16-05-2016"), "Adresse de Denis", organizer3, null);
